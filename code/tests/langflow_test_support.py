...
class TrainingTimeHarness(torch.nn.Module):
    ...
    _learned_gumbel_values = (
        algo.LangFlowFLMHybrid._learned_gumbel_values)
    _learned_gumbel_icdf = (
        algo.LangFlowFLMHybrid._learned_gumbel_icdf)
    ...
    def __init__(self, mode):
        ...
        self.learned_gumbel = mode == 'learned_gumbel'
        self.gumbel_cutoff = 1e-5
        self.gumbel_min_scale = 1e-4
        self.gumbel_entropy_raw = torch.nn.Parameter(torch.tensor(10.0))
        self.gumbel_loc_online = torch.nn.Parameter(torch.tensor(0.0))
        self.gumbel_scale_raw = torch.nn.Parameter(torch.tensor(0.5411667))
